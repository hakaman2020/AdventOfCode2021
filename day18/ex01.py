#Since I couldn't get the recursion to work I decided to change over a different
#solution I read about. This is the approach. Just use two list one with the numbers
#and one with its level. It makes the problem easier to approach.
